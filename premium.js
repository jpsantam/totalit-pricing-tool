/* ===== totalIT PREMIUM bundle =====
   Source of truth: "Copy of totalIT Bundles Calculator" workbook, PREMIUM tab.
   Everything Secure has, plus board-level cyber reporting and formal
   compliance/certification services. Line items reference services.js —
...
BUNDLES.PREMIUM = {
  ...
  items: [
    ...
    SERVICES.BOARD_BRIEFING,
    SERVICES.IT_POLICY_REVIEW,
    SERVICES.IT_RISK_REGISTER,
    SERVICES.CYBER_ESSENTIALS_CERT,
    SERVICES.ISO27001_GAP_ANALYSIS,
  ],
};
